...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans max-w-md mx-auto shadow-2xl overflow-hidden relative pb-10">
      <Header details={initialTripDetails} />
      
      {/* Navigation Tabs */}
      <div className="flex justify-center space-x-1 bg-white p-1 mx-4 mt-[-20px] rounded-xl shadow-md relative z-10 border border-gray-100">
