  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      {detailsType === 'accommodation' && (
        <>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">住宿名稱</label>
            <input
              type="text"
              name="name"
              value={formData.name || ''}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">地址</label>
            <input
              type="text"
              name="address"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Check-in</label>
            <input
              type="text"
              name="checkIn"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Check-out</label>
            <input
              type="text"
              name="checkOut"
      ...
      {(detailsType === 'outbound' || detailsType === 'inbound') && (
        <>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">航班代碼</label>
            <input
              type="text"
              name="code"
              value={formData.code || ''}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">航空公司</label>
            <input
              type="text"
              name="airline"
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">起飛地</label>
              <input
                type="text"
                name="dep"
                value={formData.dep || ''}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">抵達地</label>
              <input
                type="text"
                name="arr"
                value={formData.arr || ''}
      ...
      <div className="flex gap-2 pt-4">
        ...
        <button
          type="button"
          onClick={onCancel}
          className="flex-1 bg-gray-200 dark:bg-slate-700 text-gray-800 dark:text-slate-200 py-2 rounded-lg hover:bg-gray-300 dark:hover:bg-slate-600 font-medium"
        >
          取消
        </button>
      </div>
