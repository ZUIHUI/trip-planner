    ...
    >
      <motion.div
        ...
        className={shouldShowCoverBackground
          ? 'tp-app-header-cover text-white'
          : 'tp-app-header-surface relative overflow-hidden bg-white/80 text-stone-800 dark:bg-brand-50/80 dark:text-brand-900'}
      >
        {!shouldShowCoverBackground && (
      ...
      {children && (
        <motion.div
          className="tp-app-header-subnav border-t border-[#e0e9e0]/80 bg-white/[0.88] dark:border-brand-200/20 dark:bg-[#09100d]/[0.92]"
